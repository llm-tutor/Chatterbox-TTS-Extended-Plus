# utils/outputs/folders.py - Outputs Directory Folder Structure
...
def get_outputs_folder_structure() -> Dict[str, Any]:
    """
    Get the folder structure of output files in outputs directory
    ...
    total_files = 0
    for audio_file in outputs_dir.rglob("*"):
        if audio_file.is_file() and audio_file.suffix.lower() in audio_extensions:
            relative_path = audio_file.relative_to(outputs_dir)
